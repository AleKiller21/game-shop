...
class Profile extends Component {
    ...
    async componentDidMount () {
        // try {
        //     const gamertag
        //     const response = apiService.sendRequest(`/user/`)
        // } catch (err) {
        //     console.log(err);
        //     stateService.getFunction('showNotification')('error', 'Profile Failure', err.response.data.message);
        // }

        const { address, email, first_name, gamertag, id, last_name, profile_picture } = await stateService.getData('userInfo');
    ...
    async updateProfile (e) {
        ...
        try {
            ...
            stateService.addData('userInfo', body);
        } catch (err) {
